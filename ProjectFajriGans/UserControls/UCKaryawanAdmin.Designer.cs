namespace MyBibit.UserControls
{
    partial class UCKaryawanAdmin
    {
        ...
        private void InitializeComponent()
        {
            ...
            // lblDaftarKaryawan
            // 
            lblDaftarKaryawan.AutoSize = true;
            lblDaftarKaryawan.Font = new Font("Segoe UI", 18F, FontStyle.Bold, GraphicsUnit.Point, 0);
            lblDaftarKaryawan.ForeColor = Color.FromArgb(44, 62, 45);
            lblDaftarKaryawan.Location = new Point(255, 270);
            lblDaftarKaryawan.Name = "lblDaftarKaryawan";
            lblDaftarKaryawan.Size = new Size(303, 48);
            lblDaftarKaryawan.TabIndex = 38;
            lblDaftarKaryawan.Text = "Daftar Karyawan";
            // 
            // dgvKaryawan
            // 
            ...
            dgvKaryawan.Location = new Point(255, 338);
            dgvKaryawan.Name = "dgvKaryawan";
            dgvKaryawan.ReadOnly = true;
            dgvKaryawan.RowHeadersVisible = false;
            dgvKaryawan.RowHeadersWidth = 62;
            dgvKaryawan.RowTemplate.Height = 55;
            dgvKaryawan.Size = new Size(780, 260);
            dgvKaryawan.TabIndex = 45;
            // 
            // pnlFooter
            // 
            pnlFooter.BackColor = Color.White;
            pnlFooter.Controls.Add(btnTambahKaryawan);
            pnlFooter.Dock = DockStyle.Bottom;
            pnlFooter.Location = new Point(220, 1410);
            pnlFooter.Name = "pnlFooter";
            pnlFooter.Size = new Size(1780, 90);
            pnlFooter.TabIndex = 46;
            // 
            // btnTambahKaryawan
            // 
            btnTambahKaryawan.BackColor = Color.FromArgb(164, 190, 164);
            btnTambahKaryawan.FlatAppearance.BorderSize = 0;
            btnTambahKaryawan.FlatStyle = FlatStyle.Flat;
            btnTambahKaryawan.ForeColor = Color.White;
            btnTambahKaryawan.Location = new Point(723, 31);
            btnTambahKaryawan.Name = "btnTambahKaryawan";
            btnTambahKaryawan.Size = new Size(112, 34);
            btnTambahKaryawan.TabIndex = 3;
            btnTambahKaryawan.Text = "+";
            btnTambahKaryawan.UseVisualStyleBackColor = false;
            // 
            // btnEditKaryawan
            // 
            btnEditKaryawan.BackColor = Color.FromArgb(164, 190, 164);
            btnEditKaryawan.FlatAppearance.BorderSize = 0;
            btnEditKaryawan.FlatStyle = FlatStyle.Flat;
            btnEditKaryawan.ForeColor = Color.White;
            btnEditKaryawan.Location = new Point(310, 475);
            btnEditKaryawan.Name = "btnEditKaryawan";
            btnEditKaryawan.Size = new Size(120, 40);
            btnEditKaryawan.TabIndex = 47;
            btnEditKaryawan.Text = "Edit";
            btnEditKaryawan.UseVisualStyleBackColor = false;
            // 
            // btnNonaktifkan
            // 
            btnNonaktifkan.BackColor = Color.FromArgb(164, 190, 164);
            btnNonaktifkan.FlatAppearance.BorderSize = 0;
            btnNonaktifkan.FlatStyle = FlatStyle.Flat;
            btnNonaktifkan.ForeColor = Color.White;
            btnNonaktifkan.Location = new Point(445, 475);
            btnNonaktifkan.Name = "btnNonaktifkan";
            btnNonaktifkan.Size = new Size(140, 40);
            btnNonaktifkan.TabIndex = 48;
            btnNonaktifkan.Text = "Aktif/Nonaktif";
            btnNonaktifkan.UseVisualStyleBackColor = false;
            // 
            // btnHapusKaryawan
            // 
            btnHapusKaryawan.BackColor = Color.FromArgb(164, 190, 164);
            btnHapusKaryawan.FlatAppearance.BorderSize = 0;
            btnHapusKaryawan.FlatStyle = FlatStyle.Flat;
            btnHapusKaryawan.ForeColor = Color.White;
            btnHapusKaryawan.Location = new Point(600, 475);
            btnHapusKaryawan.Name = "btnHapusKaryawan";
            btnHapusKaryawan.Size = new Size(120, 40);
            btnHapusKaryawan.TabIndex = 49;
            btnHapusKaryawan.Text = "Hapus";
            btnHapusKaryawan.UseVisualStyleBackColor = false;
            // 
            // btnKembali
            // 
            btnKembali.BackColor = Color.FromArgb(164, 190, 164);
            btnKembali.FlatAppearance.BorderSize = 0;
            btnKembali.FlatStyle = FlatStyle.Flat;
            btnKembali.ForeColor = Color.White;
            btnKembali.Location = new Point(735, 475);
            btnKembali.Name = "btnKembali";
            btnKembali.Size = new Size(120, 40);
            btnKembali.TabIndex = 50;
            ...
            Controls.Add(btnHapusKaryawan);
            Controls.Add(btnNonaktifkan);
            Controls.Add(btnEditKaryawan);
            Controls.Add(pnlFooter);
            Controls.Add(dgvKaryawan);
            Controls.Add(lblDaftarKaryawan);
            Controls.Add(pnlAvatar);
            Controls.Add(pnlSearch);
            Controls.Add(lblWelcome);
            Controls.Add(lblTanggal);
            Controls.Add(pnlSidebar);
            Name = "UCKaryawanAdmin";
        ...
        private Label lblDaftarKaryawan;
